...
class TestDataBase(TestCase):
    ...
    def test_user_check_password(self):
        self.assertTrue(self.user.check_password('OL0098'))
    ...
    def test_cart_order_7_days(self):
        """If older than 7 days it must be deleted
        1. get cart and make it older
        ======================================
        Add come code to staticmethod Order.get_cart(user)
        """
    ...
    def test_recalculate_order_amount_after_changing_orderitem(self):
        ...
        1. Ger order amount before any changing
        2. -------""------- after adding item
    ...
    def test_method_get_amount_of_unpaid_orders(self):
        ...
        self.assertEqual(amount, Decimal(30225))
        ...
        cart.make_order()
        amount = Order.get_amount_of_unpaid_orders(self.user)
        self.assertEqual(amount, Decimal(30229))
